              ...
              <div class="col s12 m6 offset-m3 l4 offset-l4">
                <div class="card" style="background-color:#7289da;">
                  <div class="card-content white-text">
                    ...
                    <p>For my server, I had to create a discord bot with a support system <i>(ticket)</i> and differents commands. This discord bot was created with <a href="https://nodejs.org/en/" class="grey-text text-darken-3"><i class="fab fa-node"></i>NodeJs</a> and the <a href="https://discord.js.org/#/" class="grey-text text-darken-3"><i class="fab fa-discord"></i>Discord.Js Library</a>.<br> Unfortunately you can't access or see my work.</p>
                  </div>
                </div>
              </div>
            </div>
